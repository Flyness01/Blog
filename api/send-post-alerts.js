    ...
    <div style="max-width:680px;margin:0 auto;padding:34px 18px;">
      <div style="background:#f8f4ef;border:1px solid #e9ccd0;">
        <div style="background:#302830;color:#f8f4ef;padding:28px 30px;border-bottom:6px solid #d8b7bf;">
          <p style="margin:0;text-transform:uppercase;letter-spacing:2.4px;color:#d9a8b6;font-size:11px;font-weight:bold;">New note from Flyness</p>
          <h1 style="font-family:Georgia,serif;font-weight:400;font-size:38px;line-height:1.08;margin:14px 0 0;">${safeTitle}</h1>
        </div>
        <div style="padding:32px 30px;">
          <p style="font-size:16px;line-height:1.75;color:#5c505b;margin:0 0 18px;">Hi ${safeName},</p>
          <p style="font-size:16px;line-height:1.75;color:#5c505b;margin:0 0 18px;">A new note just left the lab bench. It has systems, safety, and a small amount of intellectual mischief — academically supervised, of course.</p>
          <div style="background:#eee2d7;border-left:4px solid #6d3655;padding:22px;margin:28px 0;">
            <p style="margin:0 0 8px;text-transform:uppercase;letter-spacing:1.8px;color:#6d3655;font-size:10px;font-weight:bold;">Today’s question</p>
            <p style="font-size:16px;line-height:1.65;color:#675b64;margin:0;">${safeDescription}</p>
          </div>
